...
// Connect to MongoDB (if you have a running instance; otherwise it will use the local fallback)
connectDB();
...
// Middleware to add calculation info to each request (for demonstration)
app.use((req, res, next) => {
...
// Root route serving a modern HTML page with the random calculation
app.get("/", (req, res) => {
  res.send(`
    <!DOCTYPE html>
    <html lang="en">
